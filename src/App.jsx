...
function parseUrlParams() {
  ...
  return {
    ...
    originalPrice: params.get('originalPrice') ? parseInt(params.get('originalPrice')) : null,
...
function App() {
  ...
  const deposit = customDeposit !== null
    ...
    <div className={`app ${isSlidingScale ? 'sliding-scale-mode' : ''}`}>
      ...
      {showNameModal && (
        <div className="modal-overlay" onClick={closeNameModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="modal-close" onClick={closeNameModal} disabled={isSubmitting}>×</button>
